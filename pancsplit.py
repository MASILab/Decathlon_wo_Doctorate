...
def main():
    images_input_dir = '/home-local/samirj/datasets/Task07_Pancreas/imagesTr'
    labels_input_dir = '/home-local/samirj/datasets/Task07_Pancreas/labelsTr'
    output_directory = '/home-local/samirj/datasets/Task07_Pancreas/Tumor'
