...
# Labels
labels = {"pancreas": 1, "tumor": 2, "background": 0}
...
# Directories
image_dir = "/home-local/samirj/datasets/Task07_Pancreas/imagesTs"
output_dir = "/home-local/samirj/datasets/Task07_Pancreas/Tumor/modelafter70Pred"
...
for image_file in os.listdir(image_dir):
    ...
    data = {
        "image": image_path,
        "pancreas": [[184, 208, 37], [311, 299, 92]],  # Real label points
